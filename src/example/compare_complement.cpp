...
int main(int argc, char **argv) {
  ...
  ros::Publisher osPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/octomap/static", 100);
  ros::Publisher odPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/octomap/dynamic", 100);

  ros::Publisher psPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/pplremover/static", 100);
  ros::Publisher pdPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/pplremover/dynamic", 100);

  ros::Publisher rsPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/removert/static", 100);
  ros::Publisher rdPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/removert/dynamic", 100);

  ros::Publisher esPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/erasor/static", 100);
  ros::Publisher edPublisher =
      nodeHandler.advertise<sensor_msgs::PointCloud2>("/erasor/dynamic", 100);
