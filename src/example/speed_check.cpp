...
int main(int argc, char** argv) {
  ...
  int target_idx, num_rings, num_sectors;
  double max_range, min_h, max_h;
  nh.param("/idx", target_idx, 300);
  ...
  string filename = std::to_string(target_idx);
  ...
  while (true) {
    ...
    switch (tmp) {
      case 'n':
        ...
        cout << "tf: "
             << (static_cast<double>(mid1 - start)) / CLOCKS_PER_SEC / pc_map.size() * 10000
             << std::endl;
        cout << "filter: "
             << (static_cast<double>(mid3 - mid2)) / CLOCKS_PER_SEC / pc_map.size() * 10000
             << std::endl;
        ...
        cout << "tf: "
             << (static_cast<double>(end - mid1)) / CLOCKS_PER_SEC / pc_curr.size() * 10000
             << std::endl;
        cout << "filter: "
             << (static_cast<double>(end2 - start2)) / CLOCKS_PER_SEC / pc_curr.size() * 10000
             << std::endl;
