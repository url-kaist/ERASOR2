...
void parseStaticAndDynamic(const pcl::PointCloud<pcl::PointXYZI> &cloudIn,
                           pcl::PointCloud<pcl::PointXYZI> &dynamicOut,
...
void fetch_specific_object(const pcl::PointCloud<pcl::PointXYZI> &dynamicObjs,
                           uint32_t target_class_num,
                           uint32_t target_id,
...
void fetch_specific_class(const pcl::PointCloud<pcl::PointXYZI> &dynamicObjs,
                          uint32_t target_class_num,
                          pcl::PointCloud<pcl::PointXYZI> &targetObj) {
  targetObj.points.clear();
