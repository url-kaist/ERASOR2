...
int main(int argc, char** argv) {
  ...
  //  fin.open("/media/shapelim/UX960 NVMe/kitti_semantic/dataset/sequences/00/labels/000000.label",
  //  ios::binary);
  ...
  /* Test2 */
  std::ifstream input(
      "/media/shapelim/UX960 NVMe/kitti_semantic/dataset/sequences/00/labels/000000.label",
      std::ios::binary);
  ...
  std::ifstream input2(
      "/media/shapelim/UX960 NVMe/kitti_semantic/dataset/sequences/00/veoldyne/000000.bin",
      std::ios::binary);
  // copies all data into buffer
