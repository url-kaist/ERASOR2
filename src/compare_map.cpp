...
int main(int argc, char **argv) {
    ...
    std::string raw_path, octomap_path, pplremover_path, removert_path, auto_mos_path, erasor_path, erasor2_path;
    ...
    ros::Publisher pTPPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/pplremover/TP", 100, true);
    ros::Publisher pFPPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/pplremover/FP", 100, true);
    ros::Publisher pFNPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/pplremover/FN", 100, true);
    ros::Publisher pTNPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/pplremover/TN", 100, true);
    ...
    ros::Publisher aTPPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/auto_mos/TP", 100, true);
    ros::Publisher aFPPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/auto_mos/FP", 100, true);
    ros::Publisher aFNPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/auto_mos/FN", 100, true);
    ros::Publisher aTNPub = nodeHandler.advertise<sensor_msgs::PointCloud2>("/auto_mos/TN", 100, true);
